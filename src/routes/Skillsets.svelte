...
<section class="grid min-h-svh place-items-center p-8">
	<div class="col-[1/1] row-[1/1] flex w-full max-w-screen-xl flex-col gap-8 md:gap-16">
		...
		{/if}
		<div
			class="flex grid-cols-[auto,1fr,auto,1fr] flex-wrap items-center gap-4 max-md:grid md:gap-8"
		>
			{#each skills as skill, i}
				{#if inview}
					...
					<h2
						...
						class="font-serif text-lg transition-colors hover:text-primary md:text-2xl"
					>
						{skill}
					</h2>
